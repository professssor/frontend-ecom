...
export default function Footer() {
  return (
    ...
    <div className="footerWrapper m-10  ">
      <div
        className="firstpart md:flex md:flex-wrap md:flex-row  p-4 mt-4 justify-between
   "
      >
        <div
          className="flex flex-row   w-full flex-wrap   md:w-6/12
        "
        >
          {/* first column */}
          <div className="  md:footerSubs w-6/12 lorem-text">
            ...
            <Link to={"/products/2"}>
              {" "}
              <a className="hover:underline" href="/products/2">
                <p>women</p>
              </a>
            </Link>
          ...
          <div className="   md:footerSubs w-6/12  ">
            ...
            <div className=" lorem-text">
              <a id="links" className="hover:underline" href="">
                <p>FAQ</p>
              </a>
              <a className="hover:underline" href="">
                <p>Pages</p>
        ...
        <div className=" md:flex w-full   md:w-6/12  md:justify-around  ">
          {/* third column */}
          <div id={"section1"} className="  md:footerSubs my-6 w-full">
            <h2>About</h2>
            <p className=" lorem-text mt-2">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam
              modi qui maxime soluta nisi vitae numquam ducimus id! Labore
              aspernatur ipsum sed, expedita unde modi veritatis vitae similique
              ratione quia{" "}
            </p>
          </div>
          {/* fourth column */}
      ...
      <div className="w-full md:6/12 text-center  secondpart md:flex  md:flex-row md:justify-center mt-12  ">
        <div className=" md:mr-4   md:flex justify-end items-center space-x-2 ">
          ...
          <span className=" text-xs lorem-text  ">
